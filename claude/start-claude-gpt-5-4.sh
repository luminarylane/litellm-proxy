...
# Default model names
DEFAULT_OPUS_MODEL="openai/gpt-5.5"
DEFAULT_SONNET_MODEL="openai/gpt-5.4"
DEFAULT_HAIKU_MODEL="openai/gpt-5.4-mini"

# Model specific details, autocompact at 80%
MODEL_MAX_TOKEN_WINDOW=400000
MODEL_AUTO_COMPACT_WINDOW=320000
