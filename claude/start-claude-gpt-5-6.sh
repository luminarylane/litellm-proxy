...
LITELLM_VIRTUAL_KEY="sk-claude-code-openai-5-6"
LITELLM_MODEL_NAME="openai/gpt-5.6-terra"

# Default model names
DEFAULT_OPUS_MODEL="openai/gpt-5.6-sol"
DEFAULT_SONNET_MODEL="openai/gpt-5.6-terra"
DEFAULT_HAIKU_MODEL="openai/gpt-5.6-luna"

# Model specific details, autocompact at 80%
MODEL_MAX_TOKEN_WINDOW=1050000
MODEL_AUTO_COMPACT_WINDOW=840000
...
echo "⚙️  Profile: $CLAUDE_PROFILE | thinking: $MAX_THINKING_TOKENS | output: $MODEL_MAX_OUTPUT_TOKENS"
