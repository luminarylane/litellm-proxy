...
if [[ -z "${LITELLM_OPENAI_VIRTUAL_KEY:-}" ]]; then
    echo "LITELLM_OPENAI_VIRTUAL_KEY is missing. Copy .env.example to .env and configure it." >&2
    exit 1
fi
...
LITELLM_VIRTUAL_KEY="${LITELLM_OPENAI_VIRTUAL_KEY}"
