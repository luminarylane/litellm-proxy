...
LITELLM_VIRTUAL_KEY="sk-claude-code-openai"
LITELLM_BASE_URL="http://localhost:4000"
LITELLM_MODEL_NAME="openai/gpt-5.5"
LITELLM_MODEL_MAX_TOKEN_WINDOW=400000
LITELLM_MODEL_AUTO_COMPACT_WINDOW=320000
LITELLM_MODEL_AUTO_COMPACT_PCT_OVERRIDE=80
LITELLM_MODEL_MAX_OUTPUT_TOKENS=32768
LITELLM_DEFAULT_OPUS_MODEL="openai/gpt-5.5"
LITELLM_DEFAULT_SONNET_MODEL="openai/gpt-5.4"
LITELLM_DEFAULT_HAIKU_MODEL="openai/gpt-5.4-mini"
